...
public class WeatherDataListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			row = inflater.inflate(R.layout.weather_data_list_item, parent, false);
		} else {
			row = convertView;
		}
		TextView dateTextView = (TextView) row.findViewById(R.id.weather_data_list_item_date);
		TextView temperatureTextView = (TextView) row.findViewById(R.id.weather_data_list_item_temperature);
		TextView weaterTextView = (TextView) row.findViewById(R.id.weather_data_list_item_weather);
		TextView windTextView = (TextView) row.findViewById(R.id.weather_data_list_item_wind);
		final ImageView weatherPicImageView = (ImageView) row.findViewById(R.id.weather_data_list_item_weatherPic);
		...
		SyncDownload.onLoadImage(data[position].getDayPictureUrl(), new OnLoadImageListener() {
			@Override

...
public class TempCycleDetailsArrayAdapter extends ArrayAdapter<CycleDetails> {
	Context context;
	List<CycleDetails> details;
	int resource;
	ListView view;

	public TempCycleDetailsArrayAdapter(Context context, int resource) {
	...
	public TempCycleDetailsArrayAdapter(Context context, int resource,
			List<? extends CycleDetails> details, ListView view) {
		super(context, resource);
	...
	public void getDataFormViewFirst() {
		ArrayList<CycleDetails> temp = new ArrayList<CycleDetails>();
		for (int i = 0; i < view.getChildCount(); i++) {
			temp.add(getCycleDetailsFromView(view.getChildAt(i)));
		}
		this.details = temp;
	}

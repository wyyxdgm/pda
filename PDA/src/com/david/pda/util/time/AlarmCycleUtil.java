...
public class AlarmCycleUtil {
	...
	public AlarmCycleUtil(List<CycleDetailsForAlarm> details,
	...
	private void getCycleStartEndOfCreateTime() {
		...
		case WEEK:
			...
			c.set(Calendar.SECOND, 0);
			c.set(Calendar.MILLISECOND, 0);
			while (c.get(Calendar.DAY_OF_WEEK) != 1) {// zhou ri qi shi
				c.add(Calendar.DAY_OF_MONTH, -1);
			}
			cycleStart.setTimeInMillis(c.getTimeInMillis());
			c.add(Calendar.DAY_OF_MONTH, 7 * cycleLength);
			cycleEnd.setTimeInMillis(c.getTimeInMillis());
			break;
		case YEAR:
			c.set(Calendar.HOUR_OF_DAY, 0);
	...
	private void nextCycle() {
		...
		case HOUR:
			...
			break;
		case WEEK:
			c.add(Calendar.DAY_OF_MONTH, cycleLength * 7);
			cycleStart.add(Calendar.DAY_OF_MONTH, cycleLength * 7);
			cycleEnd.add(Calendar.DAY_OF_MONTH, cycleLength * 7);
			break;
		case YEAR:
			c.add(Calendar.YEAR, cycleLength);
			cycleStart.add(Calendar.YEAR, cycleLength);
			cycleEnd.add(Calendar.YEAR, cycleLength);
			break;
		default:
			System.err.println("Error DateType!");
			break;

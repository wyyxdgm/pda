...
public class Bind {
	public static void bindReturn(ImageButton ib, final Context context,
			final Class<?> target) {
	...
	public static void bindReturn(ImageButton ib, final Context context,
			final Class<?> target, final int flags) {
		ib.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View arg0) {
				Log.i(L.t, "go back");
	...
	public static void bindReturn(Button ib, final Context context,
			final Class<?> target, final int flags) {
		ib.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View arg0) {

...
public class CycleDetailsForPrinciple extends CycleDetails {
	...
	public CycleDetailsForPrinciple() {
	}
	...
	public CycleDetailsForPrinciple(Cursor c) {
	...
	public Model getInstance(Cursor c) {
		return new CycleDetailsForPrinciple(c);
	}

	@Override
	public CycleDetails clone() {
		CycleDetailsForPrinciple c = new CycleDetailsForPrinciple();
